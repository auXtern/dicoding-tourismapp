package com.abdullah.tourismapp.core.utils

import com.abdullah.tourismapp.core.data.source.local.entity.TourismEntity
...
object DataMapper {
    ...
    fun mapDomainToEntity(input: Tourism) =
        com.abdullah.tourismapp.core.data.source.local.entity.TourismEntity(
